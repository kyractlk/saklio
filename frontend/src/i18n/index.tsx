...
const D: Dict = {
  ...
  step2: { tr: "Satır kalemleri ayrıştırılıyor", en: "Parsing line items" },
  step3: { tr: "Ürünler tanımlanıyor", en: "Identifying products" },
  step4: { tr: "Tarihler hesaplanıyor", en: "Calculating dates" },
  step5: { tr: "Neredeyse bitti", en: "Almost done" },
  ...
  confirmMultiT: { tr: "Fişteki ürünler", en: "Products on this receipt" },
  confirmMultiB: { tr: "{n} kalem bulundu — kaydetmek istediklerini seç", en: "{n} items found — select the ones to save" },
  receiptLang: { tr: "Fiş dili: {lang}", en: "Receipt language: {lang}" },
  receiptItems: { tr: "Fiş kalemleri", en: "Receipt items" },
  nItems: { tr: "{n} kalem", en: "{n} items" },
  selectAll: { tr: "Tümünü seç", en: "Select all" },
  deselectAll: { tr: "Seçimi kaldır", en: "Deselect all" },
  saveNProducts: { tr: "{n} ürünü kaydet", en: "Save {n} products" },
  findingImages: { tr: "Ürün görselleri aranıyor…", en: "Searching product images…" },
  savingProducts: { tr: "Ürünler kaydediliyor…", en: "Saving products…" },
  qtyShort: { tr: "x{n}", en: "x{n}" },
  ...
  addedN: { tr: "{n} ürün eklendi", en: "{n} products added" },
  addedMultiB: { tr: "Her biri ayrı ürün olarak kaydedildi. Görseller internetten bulundu.", en: "Each was saved as a separate product. Images were found online." },
  ...
  // data screen
  exportTitle: { tr: "Verilerimi e-posta ile gönder", en: "Email my data" },
  deleteTitle: { tr: "Verilerimi sil", en: "Delete my data" },
  exportInfo: {
    tr: "Ürünlerin, belgelerin ve asistan geçmişin dahil tüm verilerin PDF raporu olarak e-postana gönderilir.",
    en: "Your data, including products, documents and assistant history, is emailed to you as a PDF report.",
  },
  ...
  forgotTitle: { tr: "Şifremi sıfırla", en: "Reset password" },
  forgotInfo: { tr: "E-posta adresine 6 haneli bir sıfırlama kodu göndereceğiz.", en: "We'll send a 6-digit reset code to your email address." },
  forgotSend: { tr: "Kod gönder", en: "Send code" },
  forgotCodeSent: { tr: "Kod {email} adresine gönderildi.", en: "A code was sent to {email}." },
  forgotNewPass: { tr: "Yeni şifre", en: "New password" },
  forgotNewPassPh: { tr: "En az 6 karakter", en: "At least 6 characters" },
  forgotConfirm: { tr: "Şifremi sıfırla", en: "Reset my password" },
  forgotDone: { tr: "Şifren güncellendi! Şimdi giriş yapabilirsin.", en: "Password updated! You can now sign in." },
  forgotGoLogin: { tr: "Giriş ekranına dön", en: "Back to sign in" },
  ...
  shoppingSub: { tr: "İhtiyacın olanları yaz, kendine gönder", en: "Add what you need, then send it to yourself" },
  ...
  financeSub: { tr: "Bu ay nerelere harcadığını gör, e-posta ile al.", en: "See where you spent this month, then email it." },
